...
using Soenneker.Render.OpenApiClient.Services.Item.SecretFiles.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Render.OpenApiClient.Services.Item.SecretFiles
{
    /// <summary>
    /// Builds and executes requests for operations under \services\{serviceId}\secret-files
    /// </summary>
    ...
    public partial class SecretFilesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Render.OpenApiClient.Services.Item.SecretFiles.SecretFilesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecretFilesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/services/{serviceId}/secret-files{?cursor*,limit*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Render.OpenApiClient.Services.Item.SecretFiles.SecretFilesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SecretFilesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/services/{serviceId}/secret-files{?cursor*,limit*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<List<global::Soenneker.Render.OpenApiClient.Models.SecretFileWithCursor>?> GetAsync(Action<RequestConfiguration<global::Soenneker.Render.OpenApiClient.Services.Item.SecretFiles.SecretFilesRequestBuilder.SecretFilesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Soenneker.Render.OpenApiClient.Models.SecretFileWithCursor>> GetAsync(Action<RequestConfiguration<global::Soenneker.Render.OpenApiClient.Services.Item.SecretFiles.SecretFilesRequestBuilder.SecretFilesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::Soenneker.Render.OpenApiClient.Models.SecretFileWithCursor>?> PutAsync(List<global::Soenneker.Render.OpenApiClient.Models.SecretFileInput> body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Soenneker.Render.OpenApiClient.Models.SecretFileWithCursor>> PutAsync(List<global::Soenneker.Render.OpenApiClient.Models.SecretFileInput> body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Render.OpenApiClient.Services.Item.SecretFiles.SecretFilesRequestBuilder.SecretFilesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Render.OpenApiClient.Services.Item.SecretFiles.SecretFilesRequestBuilder.SecretFilesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(List<global::Soenneker.Render.OpenApiClient.Models.SecretFileInput> body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(List<global::Soenneker.Render.OpenApiClient.Models.SecretFileInput> body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Render.OpenApiClient.Services.Item.SecretFiles.SecretFilesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Render.OpenApiClient.Services.Item.SecretFiles.SecretFilesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Render.OpenApiClient.Services.Item.SecretFiles.SecretFilesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// List all secret files for the service with the provided ID.
        /// </summary>
