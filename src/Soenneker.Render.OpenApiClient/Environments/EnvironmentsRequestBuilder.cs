...
using Soenneker.Render.OpenApiClient.Environments.Item;
...
using System;
namespace Soenneker.Render.OpenApiClient.Environments
{
    /// <summary>
    /// Builds and executes requests for operations under \environments
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class EnvironmentsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>Gets an item from the Soenneker.Render.OpenApiClient.environments.item collection</summary>
        ...
        public global::Soenneker.Render.OpenApiClient.Environments.Item.WithEnvironmentItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("environmentId", position);
                return new global::Soenneker.Render.OpenApiClient.Environments.Item.WithEnvironmentItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Render.OpenApiClient.Environments.EnvironmentsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::Soenneker.Render.OpenApiClient.Models.EnvironmentWithCursor&gt;</returns>
...
#nullable enable
        public async Task<List<global::Soenneker.Render.OpenApiClient.Models.EnvironmentWithCursor>?> GetAsync(Action<RequestConfiguration<global::Soenneker.Render.OpenApiClient.Environments.EnvironmentsRequestBuilder.EnvironmentsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Soenneker.Render.OpenApiClient.Models.EnvironmentWithCursor>> GetAsync(Action<RequestConfiguration<global::Soenneker.Render.OpenApiClient.Environments.EnvironmentsRequestBuilder.EnvironmentsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Soenneker.Render.OpenApiClient.Models.EnvironmentWithCursor>(requestInfo, global::Soenneker.Render.OpenApiClient.Models.EnvironmentWithCursor.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Render.OpenApiClient.Environments.EnvironmentsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Render.OpenApiClient.Environments.EnvironmentsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Render.OpenApiClient.Environments.EnvironmentsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// List a particular project&apos;s environments matching the provided filters. If no filters are provided, all environments are returned.
        /// </summary>
...
#nullable restore
            ...
            public string[] OwnerId { get; set; }
#endif
            /// <summary>Filter for resources that belong to a project</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
