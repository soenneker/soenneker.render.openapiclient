...
using System;
namespace Soenneker.Render.OpenApiClient.Postgres.Item.Replication
{
    /// <summary>
    /// Builds and executes requests for operations under \postgres\{postgresId}\replication
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class ReplicationRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Render.OpenApiClient.Postgres.Item.Replication.ReplicationRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/postgres/{postgresId}/replication", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Render.OpenApiClient.Postgres.Item.Replication.ReplicationRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReplicationRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/postgres/{postgresId}/replication", rawUrl)
        {
        }
        /// <summary>
        /// Set up logical replication (a publication and, optionally, a replication slot) for a schema and database on a Postgres instance by ID.
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Render.OpenApiClient.Models.SetupPostgresReplication201ResponseResponseJson"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Render.OpenApiClient.Models.SetupPostgresReplication201ResponseResponseJson?> PostAsync(global::Soenneker.Render.OpenApiClient.Models.SetupPostgresReplicationRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Render.OpenApiClient.Models.SetupPostgresReplication201ResponseResponseJson> PostAsync(global::Soenneker.Render.OpenApiClient.Models.SetupPostgresReplicationRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Render.OpenApiClient.Models.SetupPostgresReplication201ResponseResponseJson>(requestInfo, global::Soenneker.Render.OpenApiClient.Models.SetupPostgresReplication201ResponseResponseJson.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Set up logical replication (a publication and, optionally, a replication slot) for a schema and database on a Postgres instance by ID.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Render.OpenApiClient.Models.SetupPostgresReplicationRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Render.OpenApiClient.Models.SetupPostgresReplicationRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Render.OpenApiClient.Postgres.Item.Replication.ReplicationRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Render.OpenApiClient.Postgres.Item.Replication.ReplicationRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Render.OpenApiClient.Postgres.Item.Replication.ReplicationRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
