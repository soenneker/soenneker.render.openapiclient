...
namespace Soenneker.Render.OpenApiClient.Models
{
    ...
    public partial class Logs200ResponseResponse : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>True if there are more logs to fetch</summary>
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Render.OpenApiClient.Models.Logs200ResponseResponse"/> and sets the default values.
        /// </summary>
        public Logs200ResponseResponse()
        {
        ...
        public static global::Soenneker.Render.OpenApiClient.Models.Logs200ResponseResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Render.OpenApiClient.Models.Logs200ResponseResponse();
        }
        /// <summary>
