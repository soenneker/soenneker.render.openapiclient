...
namespace Soenneker.Render.OpenApiClient.Models
{
    ...
    public partial class Redis : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The creation time of the Redis instance</summary>
        public DateTimeOffset? CreatedAt { get; set; }
        /// <summary>The URL to view the Redis instance in the Render Dashboard</summary>
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Render.OpenApiClient.Models.Redis"/> and sets the default values.
        /// </summary>
        public Redis()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Render.OpenApiClient.Models.Redis"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Render.OpenApiClient.Models.Redis CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Render.OpenApiClient.Models.Redis();
        }
        /// <summary>
