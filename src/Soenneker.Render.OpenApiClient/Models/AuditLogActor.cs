...
namespace Soenneker.Render.OpenApiClient.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>Email address of the actor (if applicable)</summary>
...
#nullable restore
        ...
        public string Email { get; set; }
#endif
        /// <summary>Unique identifier of the actor (if applicable)</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Render.OpenApiClient.Models.AuditLogActor"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Render.OpenApiClient.Models.AuditLogActor CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Render.OpenApiClient.Models.AuditLogActor();
        }
        /// <summary>
