...
#nullable enable
        public async Task<string?> PostAsync(global::Soenneker.Render.OpenApiClient.Models.SnapshotRestorePOST body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<string> PostAsync(global::Soenneker.Render.OpenApiClient.Models.SnapshotRestorePOST body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
