...
namespace Soenneker.Render.OpenApiClient.Events.Item
{
    ...
    public partial class WithEventItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Render.OpenApiClient.Models.RetrieveEvent200"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Render.OpenApiClient.Models.RetrieveEvent200?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Render.OpenApiClient.Models.RetrieveEvent200> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Render.OpenApiClient.Models.RetrieveEvent200>(requestInfo, global::Soenneker.Render.OpenApiClient.Models.RetrieveEvent200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieve the details of a particular event
        /// </summary>
