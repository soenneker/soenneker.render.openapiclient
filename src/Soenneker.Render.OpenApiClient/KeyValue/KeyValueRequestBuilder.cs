...
using Soenneker.Render.OpenApiClient.KeyValue.Item;
...
using System;
namespace Soenneker.Render.OpenApiClient.KeyValue
{
    /// <summary>
    /// Builds and executes requests for operations under \key-value
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class KeyValueRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Render.OpenApiClient.KeyValue.KeyValueRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public KeyValueRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/key-value{?createdAfter*,createdBefore*,cursor*,environmentId,limit*,name,ownerId,region,updatedAfter*,updatedBefore*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Render.OpenApiClient.KeyValue.KeyValueRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public KeyValueRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/key-value{?createdAfter*,createdBefore*,cursor*,environmentId,limit*,name,ownerId,region,updatedAfter*,updatedBefore*}", rawUrl)
        {
        }
        /// <summary>
        /// List Key Value instances matching the provided filters. If no filters are provided, all Key Value instances are returned.
        /// </summary>
        /// <returns>A List&lt;global::Soenneker.Render.OpenApiClient.Models.KeyValueWithCursor&gt;</returns>
...
#nullable enable
        public async Task<List<global::Soenneker.Render.OpenApiClient.Models.KeyValueWithCursor>?> GetAsync(Action<RequestConfiguration<global::Soenneker.Render.OpenApiClient.KeyValue.KeyValueRequestBuilder.KeyValueRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Soenneker.Render.OpenApiClient.Models.KeyValueWithCursor>> GetAsync(Action<RequestConfiguration<global::Soenneker.Render.OpenApiClient.KeyValue.KeyValueRequestBuilder.KeyValueRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Soenneker.Render.OpenApiClient.Models.KeyValueWithCursor>(requestInfo, global::Soenneker.Render.OpenApiClient.Models.KeyValueWithCursor.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="body">Input type for creating a Key Value instance</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Render.OpenApiClient.Models.Error">When receiving a 400 status code</exception>
        /// <exception cref="global::Soenneker.Render.OpenApiClient.Models.Error">When receiving a 401 status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Render.OpenApiClient.KeyValue.KeyValueRequestBuilder.KeyValueRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Render.OpenApiClient.KeyValue.KeyValueRequestBuilder.KeyValueRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Render.OpenApiClient.KeyValue.KeyValueRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Render.OpenApiClient.KeyValue.KeyValueRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Render.OpenApiClient.KeyValue.KeyValueRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// List Key Value instances matching the provided filters. If no filters are provided, all Key Value instances are returned.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class KeyValueRequestBuilderGetQueryParameters 
        {
