...
{
    /// <summary>
    /// Builds and executes requests for operations under \key-value\{redisId}\resume
    /// </summary>
    ...
    public partial class ResumeRequestBuilder : BaseRequestBuilder
    {
        ...
        public ResumeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/key-value/{redisId}/resume", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Render.OpenApiClient.KeyValue.Item.Resume.ResumeRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ResumeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/key-value/{redisId}/resume", rawUrl)
        {
        }
        /// <summary>
