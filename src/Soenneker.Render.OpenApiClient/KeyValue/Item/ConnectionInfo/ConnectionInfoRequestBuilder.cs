...
namespace Soenneker.Render.OpenApiClient.KeyValue.Item.ConnectionInfo
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Render.OpenApiClient.KeyValue.Item.ConnectionInfo.ConnectionInfoRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Render.OpenApiClient.Models.KeyValueConnectionInfo"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Render.OpenApiClient.Models.KeyValueConnectionInfo?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Render.OpenApiClient.Models.KeyValueConnectionInfo> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Render.OpenApiClient.Models.KeyValueConnectionInfo>(requestInfo, global::Soenneker.Render.OpenApiClient.Models.KeyValueConnectionInfo.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieve connection info for a Key Value instance by ID. Connection info includes sensitive information.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Render.OpenApiClient.KeyValue.Item.ConnectionInfo.ConnectionInfoRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Render.OpenApiClient.KeyValue.Item.ConnectionInfo.ConnectionInfoRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Render.OpenApiClient.KeyValue.Item.ConnectionInfo.ConnectionInfoRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
